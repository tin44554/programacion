...
class Viaje:
    def __init__(self, usuario, conductor, vehiculo, metodo_pago, destino):
...
viaje1 = Viaje(usuario1, conductor1, uberx, pago1, "Centro Comercial")
viaje2 = Viaje(usuario1, conductor1, ubervan, pago1, "Aeropuerto")
viaje3 = Viaje(usuario1, conductor1, uberblack, pago1, "Hotel 5 Estrellas")
